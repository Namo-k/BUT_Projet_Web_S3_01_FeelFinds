...
<body>
    ...
    <header>
        ...
        <div id="retour">
            ...
            <a href="../auth/deconnexion.php"><img src="../../images/se-deconnecter.png" width="60" height="30" style="margin-left: 15%;"/></a>
        </div>
    </header>
    ...
    <div id="container">
        <section id="profil">
            ...
            <div class="image-container" onclick="ouvrirFormulaire()">
                ...
                if ($avatarResult !== null) {
                    echo '<img src="../php-profil/get/afficherAvatar.php" alt="Avatar" class="hover-image">';
                } else {
            ...
            <div id="formulaireContainer" class="formulaire-container">
                <form action="../php-profil/avatar.php" method="post" enctype="multipart/form-data">
        ...
        <section id="personnaliser">
            ...
            <form method="POST" action="../php-profil/supprimerCompte.php" id="suppCompte">
                <div class="group">
            ...
            <form method="POST" action="../php-profil/modifier/modifierMDP.php" id="mdpModif">
                <div class="group">
        ...
        <h2>Je souhaite <span style="text-decoration: underline;" >modifier mon pseudo</span> ! Comment je fais ? </h2>
            ...
            <form method="POST" action="../php-profil/modifier/modifierPseudo.php" id="pseudoModif">
                <div class="group">
